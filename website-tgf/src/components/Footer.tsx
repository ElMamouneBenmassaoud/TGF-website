                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 mb-6 leading-relaxed">
                            Spécialiste de l'importation, du façonnage et de la pose de marbre, granite et pierres
                            naturelles depuis
                            plus de 5 ans.
                        </p>
                        <div className="flex space-x-4">
                            ...
                            <a
                                href="https://www.linkedin.com/company/travaux-g%C3%A9n%C3%A9raux-de-finitions-tgf/"
                                target="_blank"
                                rel="noreferrer"
                                className="w-10 h-10 bg-[#80251E] rounded-full flex items-center justify-center hover:bg-[#6b1f19] transition-colors"
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300">
                            ...
                            <li className="flex items-center gap-2">
                                <button
                                    onClick={() => document.getElementById("parquet")?.scrollIntoView({behavior: "smooth"})}
                                    className="hover:text-white/90 transition flex items-start gap-1"
                                >
                                    <span>Revêtement Parquet</span>

                                    {/* Nouveau en exposant + animation */}
                                    <span className="relative -top-1 text-[10px] font-bold text-red-500 badge-wiggle">
                                      Nouveau
                                    </span>
                                </button>
                            </li>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="text-gray-300">+212 661 60 11 67 · +212 522 52 45 89</span>
                            </div>
                            <div className="flex items-center">
                                <Mail className="w-5 h-5 text-[#80251E] mr-3"/>
                                <span className="text-gray-300">info@tgf.ma</span>
                            </div>
                        </div>
                    </div>
                </div>
