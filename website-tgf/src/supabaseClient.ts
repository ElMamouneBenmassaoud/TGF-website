...
const supabaseUrl = 'https://igskqwdfrfgtspagtrgy.supabase.co'; // ← à remplacer
const supabaseKey = 'sb_publishable_5RHrZ7qrbLLD0pzLjx0frA_G0CqR95g'; // ← à remplacer aussi
